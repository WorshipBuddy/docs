Overview of the .show format if you would like to convert something else into a PresenterBuddy show file.

The data type is JSON. Supported file extensions are .show or .json.
