...
# Schedule actions
If you select "Schedule action" on the left side, you can add events to automatically start specific actions any time in the future, as long as PresenterBuddy is opened. This will notify you about it starting a minute before it runs.