...
In the drawer you can add different actions that is triggered when receiving a MIDI in signal. You can also click on exising actions to trigger them directly.

# Editing actions
When creating or editing an action you can choose to enable "Activate by MIDI signal". PresenterBuddy has some default values for all of the actions, but you can set your own values by disabling the "Use default values" switch.
