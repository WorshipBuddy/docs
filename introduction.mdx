...
<CardGroup cols="3">
  <Card title="Mac" href="https://guide.worshipbuddy.org/mac">
    Instructions to install on MacOS
  </Card>
  <Card title="Windows" href="https://guide.worshipbuddy.org/windows">
    Instructions to install on Windows
  </Card>
  <Card title="Linux" href="https://guide.worshipbuddy.org/linux">
