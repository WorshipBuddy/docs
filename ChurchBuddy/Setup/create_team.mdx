...
<Info>
Only the organization **Owner** or an **Organization Admin** can create teams. Team Admins can edit teams they administer but cannot create new ones.
</Info>
...
- **Quantity** (required) — How many people are needed (UI limit **1–10** per position)
...
- **Remove** — Click the **×** button to remove a position
...
4. Use the **×** button to delete any position you don't need
