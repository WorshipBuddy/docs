...
See the [Service Check-In documentation](/ChurchBuddy/Day-to-Day/service-check-in) for detailed information about each method.
...
The **Scheduler** (accessed from the More tab, available to Owners, Org Admins, Schedulers, and Team Admins) allows you to assign people to positions for upcoming services.
