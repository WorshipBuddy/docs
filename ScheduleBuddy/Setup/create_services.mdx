...
A service is a single meeting, like a single Sunday service or Bible study. You can create multipleand they will be ordered chronologically. Here you will also be able to create schedules as well as export them as an excel or word file.
...
3. Here, you can fill out all the information for your service:
    ...
    2. Location: This will autofill the address you specified when starting the org. You can change this address at anytime.
...
You have just created a new service! You can always find and edit all your services in the services page. Now lets add users to your org.